...
async def send_for_index(bot, message):
    ...
    if message.from_user.id in ADMINS:
        buttons = [
            [
                InlineKeyboardButton('ʏᴇs', callback_data=f'index#accept#{chat_id}#{last_msg_id}#{message.from_user.id}')
            ],
            [
    ...
    buttons = [
        [
            InlineKeyboardButton('ᴀᴄᴄᴇᴘᴛ ɪɴᴅᴇx', callback_data=f'index#accept#{chat_id}#{last_msg_id}#{message.from_user.id}')
        ],
        [
            InlineKeyboardButton('ʀᴇᴊᴇᴄᴛ ɪɴᴅᴇx', callback_data=f'index#reject#{chat_id}#{message.message_id}#{message.from_user.id}'),
        ]
        ]
    reply_markup = InlineKeyboardMarkup(buttons)
